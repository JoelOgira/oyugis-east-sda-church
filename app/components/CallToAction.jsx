...
export default function CallToAction() {
    return (
        <main className="w-full">
            <div className="bg-gradient pt-12 pb-16">
                <h2 className='text-white font-bold text-xl pb-8 max-w-sm px-3 md:px-0 md:mx-auto md:text-center lg:text-3xl lg:max-w-2xl'>
                ...
                <div className="flex flex-col-reverse justify-center items-center px-3 md:flex-row md:space-x-10 md:px-0 md:container md:mx-auto md:w-5/6 lg:w-3/4 text-white">
                    ...
                    <div className="flex flex-col space-y-4 md:w-1/2 [&>blockquote]:text-gray-300">
                        ...
                        <blockquote className="text-sm leading-6 md:text-base lg:max-w-4xl lg:leading-8">
                            In Oyugis East Seventh-day Adventist Church, we support each other in embracing the path that aligns with God's plan for us. Whether you're just starting or well along your journey, you're encouraged to uncover your calling and live it to the fullest at our Church.
                        </blockquote>
